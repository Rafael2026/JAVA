...
public final class modificacion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<body>\n");
      out.write("  \n");
      out.write("  <h1>BBDD Personas - Tabla alumnos - Modificación</h1>\n");
      out.write("    \n");
      out.write("  ");
    ...
    ResultSet listado = sentencia.executeQuery("SELECT * FROM alumno");
    ...
    while (listado.next()) {
      ...
      codigo = Integer.parseInt (listado.getString ("cod_alu"));
      nombre = listado.getString ("nom_alu");
      apellidos = listado.getString ("ape_alu");
