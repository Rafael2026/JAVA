...
public final class procesarAlta_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <title>Dar de alta a los alumnos</title>\n");
      out.write("</head>\n");
      out.write("\n");
      out.write("<body>\n");
      out.write("  \n");
    ...
    String insercion = "INSERT INTO alumno VALUES ("
      + "'" + Integer.parseInt (request.getParameter("cod_alu")) + "'"
      + ", " + "'" + request.getParameter("nom_alu") + "'"
      + ", " + "'" + request.getParameter("ape_alu") + "'" + ")";
